// If  don't want to host your server code and client code together,  can
// pay AWS to host the server with HTTPS then config the api url endpoints.
// const SERVER_ORIGIN = '<Your server's url> '; local host or depoyed url
const SERVER_ORIGIN = '';
